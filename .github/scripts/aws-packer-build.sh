...
# KMS_VERSION=5.17.0 # Provided by Github workflow
# AI_RUNNER_VERSION=1.0.1 # Provided by Github workflow
# GITHUB_REF=refs/tags/1.3.21 # Provided by Github Actions
# GITHUB_REF_NAME=1.3.21 # Provided by Github Actions
...
if [ -n "${VERSION+x}" ]; then
  ...
  if [ "$DISTRIBUTION" = "ubuntu" ]; then
    ...
    BASE_IMAGE_NAME="RHEL-10.1.0_HVM-20260108-x86_64-0-Hourly2-GP3"
  fi
fi
