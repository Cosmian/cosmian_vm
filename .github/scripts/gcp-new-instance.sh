...
if [ "$TECHNO" = "tdx" ]; then
  ...
  gcloud compute instances create "$NAME" \
    ...
    --image=ubuntu-2404-noble-amd64-v20260517 \
    --project cosmian-dev \
    --tags "$NAME-cli" \
  ...
  if [ "$DISTRIB" = "ubuntu" ]; then
    ...
    # Cosmian Ubuntu SEV
    IMAGE="cosmian-vm-1-3-21-sev-ubuntu"
    IMAGE_PROJECT="cosmian-dev"
    # Cosmian KMS Ubuntu SEV
    IMAGE="cosmian-vm-1-3-21-kms-5-11-0-sev-ubuntu"
    IMAGE_PROJECT="cosmian-dev"
    # Ubuntu SEV
    IMAGE="ubuntu-2404-noble-amd64-v20260517"
    ...
    IMAGE_PROJECT="cosmian-dev"
    # Cosmian vm RHEL SEV
    IMAGE="cosmian-vm-1-3-21-rhel-sev"
    IMAGE_PROJECT="cosmian-dev"
    # Cosmian kms RHEL SEV
    IMAGE="cosmian-vm-1-3-21-kms-5-11-0-sev-rhel"
    IMAGE_PROJECT="cosmian-dev"
