...
build {
  ...
  provisioner "ansible" {
    ...
    local_port      = 22
    use_proxy       = false
    extra_arguments = ["-vvv", "-e", "cosmian_vm_version=TEMPLATE_COSMIAN_VM_VERSION", "-e", "cosmian_kms_version=TEMPLATE_COSMIAN_KMS_VERSION", "-e", "cosmian_ai_runner_version=TEMPLATE_COSMIAN_AI_RUNNER_VERSION"]
  }
}
